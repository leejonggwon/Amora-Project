...
<body>
 ...
 ;
 %>
		<!-- <a href="#menu">개인정보수정 로그아웃</a> --> <!-- 로그인 후 Logout.jsp로 이동할 수 있는'로그아웃'링크와 '개인정보수정'링크를 출력하시오. -->
		</nav> </header>
			...
			<div class="inner">
				...
				<ul class="actions">
					...
					for (int i = 0; i < list.size(); i++) {
						//1.아이유-이번 주 금요일 시간이 어때요? (2023-07-27 16:00)
						out.print("<li>");
						out.print(i + 1 + ".");
